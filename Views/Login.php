...
<div class="auth row">
    <div class="col-lg-6 auth-form">
        ...
        <div class="login">
            <fom action="#" method="post" id="form-login">
                ...
                <div class="d-flex justify-content-center">
                    <a href="javascript:loginWithFacebook();" class="btn btn-signin btn-primary input-block-level mx-1 h-40 my-3">
                    ...
                    <a href="https://www.linkedin.com/oauth/v2/authorization?response_type=code&amp;client_id=86umgx5hytpk2k&amp;redirect_uri=https%3A%2F%2Fwww.topcv.vn%2Fcallback-linkedin&amp;scope=r_liteprofile+r_emailaddress" class="btn btn-default btn-signin btn-signin-linkedin input-block-level mx-1 h-40 my-3">
    ...
    <div id="login-slider" class="px-0 col-6 carousel slide d-none d-lg-block" data-ride="carousel">
        <div id="carouselLogin" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#carouselLogin" data-bs-slide-to="0" class="active" aria-label="Slide 1" aria-current="true"></button>
                <button type="button" data-bs-target="#carouselLogin" data-bs-slide-to="1" aria-label="Slide 2" class=""></button>
                <button type="button" data-bs-target="#carouselLogin" data-bs-slide-to="2" aria-label="Slide 3" class=""></button>
            </div>
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="img-top">
                        <img src="./Đăng nhập tài khoản CV Online - TopCV.vn_files/tool-cv.webp" class="w-100" alt="...">
                    </div>
                ...
                <div class="carousel-item">
                    <div class="img-top">
                        <img src="./Đăng nhập tài khoản CV Online - TopCV.vn_files/sec-safe.webp" class="w-100" alt="...">
                    </div>
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <div class="img-top">
                        <img src="./Đăng nhập tài khoản CV Online - TopCV.vn_files/support.webp" class="w-100" alt="...">
                    </div>
                    <div class="carousel-caption d-none d-md-block">
